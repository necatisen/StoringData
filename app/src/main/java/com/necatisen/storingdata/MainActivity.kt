package com.necatisen.storingdata
...
import com.necatisen.storingdata.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPreferences = this.getSharedPreferences("com.necatisen.storingdata", Context.MODE_PRIVATE)
